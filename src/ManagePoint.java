...
public class ManagePoint extends JPanel {
   ...
   //   viewLabel.setBounds(350, 150, 500, 150);
      viewLabel.setFont(defaultFont.deriveFont(25f));
      viewPoint.setFont(defaultFont.deriveFont(80f));
      ...
      addPointButton.setFont(defaultFont.deriveFont(25f));
      ...
      backToHome.setFont(defaultFont.deriveFont(25f));
